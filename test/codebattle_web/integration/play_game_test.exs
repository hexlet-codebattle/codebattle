defmodule Codebattle.PlayGameTest do
  ...
  setup do
    user1 = User.changeset(%User{}, %{name: "first", email: "test1@test.test", github_id: 1, raiting: 10})
    user2 = User.changeset(%User{}, %{name: "second", email: "test2@test.test", github_id: 2, raiting: 10})
