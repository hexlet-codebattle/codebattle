...
production-deploy:
	ansible-playbook ansible/deploy.yml -i ansible/production -u $U --ask-vault-pass --ask-become-pass
...
production-upload-langs:
	ansible-playbook ansible/langs.yml -i ansible/production -u $U -vv --ask-vault-pass
