defmodule Codebattle.GroupTournamentPlayer do
  ...
  @derive {Jason.Encoder, only: [:id, :group_tournament_id, :user_id, :lang, :state, :last_setup_at, :inserted_at]}
  ...
  def changeset(player, attrs \\ %{}) do
    player
    |> cast(attrs, [:group_tournament_id, :user_id, :lang, :state, :last_setup_at])
