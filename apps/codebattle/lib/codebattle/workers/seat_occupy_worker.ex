defmodule Codebattle.Workers.SeatOccupyWorker do
  @moduledoc """
  Occupies a code-assist seat for a single tournament user. Oban retries on failure.
  """
  ...
  def perform(%Oban.Job{args: %{"user_id" => user_id, "group_tournament_id" => group_tournament_id}}) do
    UserGroupTournamentContext.occupy_user_seat(user_id, group_tournament_id)
  end
end
