...
const getProgress = (a: number, b: number) => 100 - Math.ceil((a / b) * 100);

const getDuration = (time: string, timeoutSeconds: number) => {
...
function CountdownTimer({ time, timeoutSeconds, colorized = false }: CountdownTimerProps) {
