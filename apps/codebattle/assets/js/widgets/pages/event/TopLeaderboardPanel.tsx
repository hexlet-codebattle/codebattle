...
const getCustomEventTrClassName = (item: TopLeaderboardItem, selectedId?: number | string) =>
  cn(
...
interface TopLeaderboardPanelProps {
  topLeaderboard?: TopLeaderboardItem[];
  selectedId?: number | string;
}

function TopLeaderboardPanel({ topLeaderboard = [], selectedId }: TopLeaderboardPanelProps) {
  return (
