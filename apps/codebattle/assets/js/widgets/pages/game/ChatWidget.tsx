      ...
      <div className="d-flex cb-game-chat-layout cb-bg-panel shadow-sm h-100 cb-rounded">
        ...
        >
          ...
          {openedReplayer ? (
            <Messages
              messages={
                historyMessages as unknown as React.ComponentProps<typeof Messages>['messages']
              }
              disabled={disabledChatMessages}
            />
          ) : (
            <Messages
              displayMenu={displayMenu as React.ComponentProps<typeof Messages>['displayMenu']}
              messages={
