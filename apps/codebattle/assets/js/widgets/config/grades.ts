...
export const getRankingPoints = (grade: Grade | string) => {
  switch (grade) {
    ...
    case grades.masters:
      return [1024, 512, 256, 128, 64, 32, 16, 8, 4, 2];
    case grades.grandSlam:
      return [2048, 1024, 512, 256, 128, 64, 32, 16, 8, 4, 2];
    default:
      return [0];
  }
};

export const getTasksCount = (grade: Grade | string) => {
  switch (grade) {
    case grades.rookie:
      return 4;
    case grades.challenger:
