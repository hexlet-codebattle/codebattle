// assets/js/widgets/initEditor.ts
...
loader.init().then((monacoInstance) => {
  ...
  monacoInstance.languages.setMonarchTokensProvider(
    'stylus',
    stylusProvider as monaco.languages.IMonarchLanguage,
  );
  ...
  monacoInstance.languages.setMonarchTokensProvider(
    'scss',
    sassProvider as monaco.languages.IMonarchLanguage,
  );
  ...
  monacoInstance.languages.setMonarchTokensProvider(
    'mongodb',
    mongodbProvider as monaco.languages.IMonarchLanguage,
  );
  monacoInstance.languages.setLanguageConfiguration(
    'mongodb',
    mongodbLangConf as unknown as monaco.languages.LanguageConfiguration,
  );
  ...
  monacoInstance.languages.setMonarchTokensProvider(
    'zig',
    zigProvider as monaco.languages.IMonarchLanguage,
  );
