...
#       game_id: Helpers.get_game_id(fsm),
#       game_type: Helpers.get_type(fsm),
#       task_id: Helpers.get_task(fsm).id,
#       bot_id: Helpers.get_first_player(fsm).id,
#       bot_time_ms: get_bot_time(fsm)
#     })
#   end

#   defp get_bot_time(fsm) do
#     player = Helpers.get_second_player(fsm)
#     game_level = Helpers.get_level(fsm)
...
#     case Helpers.get_rematch_state(fsm) do
#       :in_approval ->
