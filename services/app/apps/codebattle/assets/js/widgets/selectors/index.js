...
export const currentUserIsAdminSelector = (state) =>
  state.user.users[state.user.currentUserId].is_admin;

export const currentUserIsGuestSelector = (state) =>
  state.user.users[state.user.currentUserId].is_guest;
...
export const leftEditorSelector = (roomCurrent) =>
...
export const rightEditorSelector = (roomCurrent) =>
  createDraftSafeSelector(
    (state) => state,
    (state) => {
      const currentUserId = currentUserIdSelector(state);
...
export const userLangSelector = (state) => (userId) =>
...
export const executionOutputSelector = (roomCurrent, userId) => (state) =>
  roomCurrent.matches({ replayer: replayerMachineStates.on })
