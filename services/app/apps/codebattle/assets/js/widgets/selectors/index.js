...
export const currentUserIsAdminSelector = (state) =>
  !!state.user.users[state.user.currentUserId].isAdmin;
...
export const userIsAdminSelector = (userId) => (state) =>
  !!state.user.users[userId]?.isAdmin;
...
export const singleBattlePlayerSelector = (state) => {
  ...
  const playersWithoutBot = Object.values(players).filter(
    (player) => !player.isBot,
  );
...
export const editorTextHistorySelector = (state, { userId }) =>
  state.editor.textHistory[userId];

export const editorLangHistorySelector = (state, { userId }) =>
  state.editor.langsHistory[userId];

export const currentUserSelector = (state) =>
  state.user.users[state.user.currentUserId];
...
export const taskTemplatesStateSelector = (state) =>
  state.builder.templates.state;
...
export const taskParamsTemplatesStateSelector = (state) =>
  state.builder.templates.state;

export const taskSolutionSelector = (state, lang) =>
  state.builder.textSolution[lang];
...
export const executionOutputSelector =
  (playerId, roomMachineState) => (state) =>
    roomMachineState &&
    roomMachineState.matches({ replayer: replayerMachineStates.on })
...
export const tournamentHideResultsSelector = (state) =>
  !state.tournament.showResults;

export const tournamentOwnerIdSelector = (state) => state.tournament.ownerId;

export const currentTournamentPlayerSelector = (state) =>
  state.tournamentPlayer;
...
export const chatHistoryMessagesSelector = (state) =>
...
export const taskDescriptionLanguageSelector = (state) =>
...
export const showVideoConferencePanelSelector = (state) =>
  state.gameUI.showVideoConferencePanel;

export const playbookStatusSelector = (state) => state.playbook.state;

export const playbookInitRecordsSelector = (state) =>
  state.playbook.initRecords;
...
export const eventTopLeaderboardSelector = (state) =>
  state.event.topLeaderboard;

export const eventCommonLeaderboardSelector = (state) =>
  state.event.commonLeaderboard;
