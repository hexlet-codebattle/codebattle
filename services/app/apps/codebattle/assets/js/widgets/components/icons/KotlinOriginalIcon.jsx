...
function KotlinOriginalIcon({ className, size = '1em' }) {
  ...
  return (
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" className={className} style={{ width: size, height: size }}>
      <linearGradient id={id('a')} gradientUnits="userSpaceOnUse" x1="-11.899" y1="48.694" x2="40.299" y2="-8.322">
      ...
      <linearGradient id={id('b')} gradientUnits="userSpaceOnUse" x1="43.553" y1="149.174" x2="95.988" y2="94.876">
        <stop offset="0" stopColor="#1c93c1" />
        <stop offset=".216" stopColor="#2d8ebf" />
        <stop offset=".64" stopColor="#587eb9" />
        <stop offset=".995" stopColor="#7f6cb1" />
      </linearGradient>
      <linearGradient id={id('c')} gradientUnits="userSpaceOnUse" x1="3.24" y1="95.249" x2="92.481" y2="2.116">
