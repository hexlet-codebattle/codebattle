...
function TeamTournamentInfoPanel({
  state,
  players,
  matches,
  statistics,
    ...
    <>
      <ul className="nav nav-tabs" id="team-tournament-tab" role="tablist">
        <li className="nav-item">
          <a
            href="#scores"
            className="nav-link border-0 bg-white text-dark active"
            id="scores-tab"
            data-toggle="tab"
            role="tab"
        ...
        <li className="nav-item">
          <a
            href="#rating"
            className="nav-link border-0 bg-white text-dark"
            id="rating-tab"
            data-toggle="tab"
            role="tab"
        ...
        >
          <div className="py-2 bg-white shadow-sm rounded">
            <div className="row align-items-center">
              <div className="col-4">
                <h3 className="mb-0 px-3 font-weight-light">
                  {getTeamNames(tournament)[0]}
                </h3>
              </div>
